...
CreateConVar("randomat_fstanley_scale", 0.2, {FCVAR_NOTIFY, FCVAR_ARCHIVE}, "Flatness size multiplier", 0.1, 0.5)
...
function EVENT:Begin()
    ScalePlayerFlat(GetConVar("randomat_fstanley_scale"):GetFloat())
end
